...
class OpenAiConversationalProvider implements ConversationalAiProviderInterface
{
    ...
    private function extractionInstructions(array $services, array $collected): string
    {
        ...
        return "Use the update_intake_fields tool whenever the visitor provides or corrects "
            ...
            ."PRIORITY: deepen PROJECT SCOPE with clarifying questions first "
            ."(condition, size, height/access, finish/paint scope, photo offer). "
            ."Do NOT ask for contact_name or phone until scope is mostly understood — "
            ."ask for contact around the scope-confirmation step, not as the first follow-up. "

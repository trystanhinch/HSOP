    ...
    */
    ...
    'disks' => [
        ...
        's3' => [
            ...
            'use_path_style_endpoint' => str_contains((string) env('AWS_ENDPOINT', ''), 'digitaloceanspaces.com')
                ? true
                : filter_var(env('AWS_USE_PATH_STYLE_ENDPOINT', false), FILTER_VALIDATE_BOOL),
            'visibility' => 'public',
            'throw' => false,
            'report' => false,
        ],

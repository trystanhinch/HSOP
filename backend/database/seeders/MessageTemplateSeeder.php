    ...
    public function run(): void
    {
        $templates = [
            ...
            [
                ...
                'channel' => 'sms',
                'variables' => ['company_name', 'customer_total', 'portal_url'],
                'body' => '{{company_name}}: Your quote is ready. Total: ${{customer_total}}. Review and respond here: {{portal_url}}',
            ],
            [
                'event_key' => 'job_complete_pending_approval',
                'label' => 'Job complete — customer review',
                'channel' => 'sms',
                'variables' => ['company_name', 'customer_name', 'address', 'portal_url'],
                'body' => '{{company_name}}: Hi {{customer_name}}, work at {{address}} is marked complete. Please review and accept here: {{portal_url}}',
            ],
            [
                'event_key' => 'revision_requested',
                'label' => 'Revision requested',
                'channel' => 'sms',
                'variables' => ['company_name', 'address', 'description'],
                'body' => '{{company_name}}: Customer requested a revision for {{address}}: {{description}}',
            ],
            [
                ...
                'channel' => 'sms',
                'variables' => ['company_name', 'customer_name', 'address', 'portal_url'],
                'body' => '{{company_name}}: Hi {{customer_name}}, there is a new progress update on your project at {{address}}. View photos and notes: {{portal_url}}',
            ],
            [
            ...
            [
                ...
                'channel' => 'sms',
                'variables' => ['company_name', 'pm_name', 'lead_name', 'lead_id'],
                'body' => '{{company_name}} escalation: PM has not contacted lead #{{lead_id}} ({{lead_name}}). Please follow up.',
            ],
            [
                'event_key' => 'contractor_pricing_reminder_pm',
                'label' => 'Contractor pricing overdue (PM)',
                'channel' => 'sms',
                'variables' => ['company_name', 'lead_name', 'lead_id'],
                'body' => '{{company_name}}: Contractor pricing still outstanding for {{lead_name}} (lead #{{lead_id}}).',
            ],
            [
                'event_key' => 'pm_intro_customer',
                'label' => 'PM intro draft fallback',
                'channel' => 'sms',
                'variables' => ['company_name', 'customer_name', 'pm_name'],
                'body' => 'Hi {{customer_name}}, this is {{pm_name}} from {{company_name}} following up on your project inquiry. When is a good time to chat?',
            ],
            [
                'event_key' => 'review_request_customer',
                'label' => 'Review request (customer)',
                'channel' => 'sms',
                'variables' => ['company_name', 'customer_name', 'review_url', 'address'],
                'body' => 'Hi {{customer_name}}, thanks for choosing {{company_name}}! Please rate your experience (1-5 stars): {{review_url}}',
            ],
        ];
